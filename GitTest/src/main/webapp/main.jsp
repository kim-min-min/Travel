...
<script>
   function goToSelect() {
      ...
      if (startDate && endDate) {
          window.location.href = 'select.jsp?region=' + selectedRegion + '&start=' + startDate + '&end=' + endDate;
      } else {
          alert('여행 날짜를 선택해주세요.');
      }
   }
   ...
   <div class="root">
      <header class="header">
         <div class="trip-planner">
            <span class="navTxt"><a href="#plan" style="color: #20303c">
            <u>여행 일정 만들기</u></a></span>
         </div>
         <div class="div"></div>
         <%
         if (member == null) {
                  ...
                  <div class="date-bar">
                     <div class="date-buttons">
                        ...
                        <div class="date-box">
                           ...
                           <input type="date" id="start" class="date-input" name="start">
                        </div>
                     </div>
                     <div class="date-buttons1">
                        ...
                        <div class="date-box">
                           <img class="button-date-icon" alt="달력" src="image/Vector.png" />
                           <input type="date" id="end" class="date-input" name="end">   
                        </div>
                     </div>
                  </div>
               </div>
