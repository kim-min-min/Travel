...
<head>
    ...
    if (places == null || places.isEmpty()) {
        response.sendRedirect("getPlace?region=BUSAN&start=" + startDate + "&end=" + endDate); // 기본값으로 'busan' 사용
        return;
    }
    %>
    <style>
    ...
    var currentPage = 0;
    var itemsPerPage = 4;
    var totalItems = <%= places.size() %>; // JSP 표현식을 사용하여 총 항목 수를 가져옵니다.
...
<body>
    ...
    <div class="image-1-parent">
        ...
        <div class="list">
            <div class="item-link">
                <a href="getPlace?region=BUSAN&start=<%= startDate %>&end=<%= endDate %>">
                    <div class="frame">
            ...
            <div class="item-link1">
                <a href="getPlace?region=YangYang&start=<%= startDate %>&end=<%= endDate %>">
                    <div class="frame-div">
            ...
            <div class="item-link2">
                <a href="getPlace?region=YEOSU&start=<%= startDate %>&end=<%= endDate %>">
                    <div class="wrapper1">
...
<%--         <div class="date-display">
            <span>여행 날짜: <%= startDate %> ~ <%= endDate %></span>
        </div> --%>
        <div class="listbox">
